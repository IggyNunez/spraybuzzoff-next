 ...
 */
import { SITE, EMAIL, NAP, NAP_DIRECTORIES } from "../../../seo-stack.config.mjs";
...
// Single source of truth for this project, pulled from the per-site
// config. Keep seo-stack.config.mjs in sync with the site's JSON-LD.
const SOURCE_OF_TRUTH = NAP;

const DIRECTORIES = NAP_DIRECTORIES;
